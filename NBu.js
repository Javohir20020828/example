...
function calculate(){
  let amount = parseFloat(document.querySelector('#first-num').value);   //  input 
  let select =  document.querySelector('#valyutaTurlari');   //  valyuta turlari
  let result =  document.querySelector('#second-num');           //   result input
  ...
  if(select.value === ''){
      ...
      result.placeholder = amount * 1085.85;
    }
  else if (select.value === "RUB"){
      result.placeholder = (amount * 130.06);
  }
  else if (select.value === "JPY"){
      result.placeholder = (amount * 94.17);
  }
  else if (select.value === "KZT"){
      result.placeholder = (amount * 23.60);
  } else {
